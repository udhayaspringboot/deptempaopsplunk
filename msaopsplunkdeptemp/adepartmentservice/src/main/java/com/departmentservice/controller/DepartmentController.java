...
@Value("${message}")
	 ...
	 * dept) { logArgs.put("sourcetype", "Test_splunk"); receiver.log("main",
	 * logArgs, " ..............From Department Controller......................");
	 * 
	 ...
	 * 
	 * 
	 * @GetMapping("/listDept") public Departments getAllDept()
	 * {logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 * 
	 * 
	 * List<Department> lis = departmentService.readAllDeptServ(); Departments depts
	 * = new Departments(); depts.setDepartments(lis);
	 * 
	 * receiver.log("main", logArgs, "calling department list service method ");
	 * System.out.println("lis vals message"+message); return depts; }
	 * 
	 * @PutMapping("/updateDept/{depId}") public boolean updateDept(@RequestBody
	 * Department dept,@PathVariable int depId) { logArgs.put("sourcetype",
	 * "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 * 
	 * 
	 * System.out.println("dept updating values"+depId + "name "+dept.getDeptName()
	 * +"loc "+dept.getDeptLoc()); dept.setDeptId(depId);
	 * departmentService.updateDeptServ(dept);
	 * 
	 ...
	 * }
	 * 
	 * @DeleteMapping("/deleteDept/{depIds}") public boolean
	 * deleteDept(@PathVariable int depIds) { logArgs.put("sourcetype",
	 * "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 * 
	 ...
	 * "Department associated employee also deleted Successfully"); return true;
	 * 
	 * }
	 * 
	 * @GetMapping("/employee/listEmp/{deptId}") public Employees
	 * getEmployees(@PathVariable int deptId) { logArgs.put("sourcetype",
	 * "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 * receiver.log("main", logArgs, " calling employee list service method");
	 * 
	 * //receiver.log("main", logArgs, "Department Saved Successfully"); Employees
	 * emp = employeeService.readEmpFromDeptServ(deptId);
	 * 
	 * return emp;
	 * 
	 * }
	 * 
	 * @PostMapping("/employee/saveEmp/{deptEmpFk}") public Employee
	 * saveEmp(@RequestBody Employee emp,@PathVariable int deptEmpFk) {
	 * List<Department> lisDept = departmentService.readAllDeptServ();
	 ...
	 * for (Department department : lisDept) {
	 * 
	 * if(department.getDeptId() == deptEmpFk) { emp.setDeptEmpFk(deptEmpFk);
	 * receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 ...
	 * 
	 * 
	 * return employeeService.createEmpServ(emp); } } return emp;
	 * 
	 * }
	 * 
	 * @PutMapping("/employee/updateEmp/{empId}") public String
	 * updateEmp(@RequestBody Employee emp,@PathVariable int empId) {
	 * emp.setEmpId(empId); employeeService.updateEmpServ(emp);
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
	 ...
	 * return "Employee Updated Successfully"; }
	 * 
	 * @DeleteMapping("/employee/deleteEmp/{empId}/{deptEmpFk}") public String
	 * deleteEmp(@PathVariable int empId,@PathVariable int deptEmpFk) {
	 * 
	 * employeeService.deleteEmpFromDeptServ(empId, deptEmpFk);
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From Department Controller......................");
