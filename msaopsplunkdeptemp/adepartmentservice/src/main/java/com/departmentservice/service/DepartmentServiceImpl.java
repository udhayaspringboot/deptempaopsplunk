...
public class DepartmentServiceImpl implements DepartmentService {
	 ...
	 * 
	 * @Override public Department createDeptServ(Department dept) {
	 * 
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From department service......................");
	 * 
	 * receiver.log("main", logArgs, "Calling department save  dao method"); return
	 * deptDao.createDept(dept);
	 * 
	 * }
	 * 
	 * @Override public boolean updateDeptServ(Department dept) {
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From department service......................");
	 * 
	 * receiver.log("main", logArgs, "Calling department update  dao method");
	 * deptDao.updateDept(dept); return true; }
	 * 
	 * @Override public List<Department> readAllDeptServ() {
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From department service......................");
	 * 
	 * receiver.log("main", logArgs, "Calling department list  dao method"); return
	 * deptDao.readAllDept(); }
	 * 
	 * @Override public boolean delteDeptServ(int depIds) {
	 * logArgs.put("sourcetype", "Test_splunk"); receiver.log("main", logArgs,
	 * " ..............From department service......................");
	 * 
	 * receiver.log("main", logArgs, "Calling department delete  dao method");
	 * deptDao.delteDept(depIds); return true; }
	 */
}
